...
create table grupo_permissoao (grupo_id bigint not null, permissao_id bigint not null) engine=InnoDB;
...
alter table grupo_permissoao add constraint FKk7orgtvso6y9v5ihky5vqy2ct foreign key (permissao_id) references permissao (id);
alter table grupo_permissoao add constraint FK8nvcua4cv22wo4299vntf38gw foreign key (grupo_id) references grupo (id);
